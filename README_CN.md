...
| 📖 | [SKILL.md](../ppt-master-skill/SKILL.md) | 核心流程与规则（skill 仓库） |
| 📐 | [画布格式](../ppt-master-skill/references/canvas-formats.md) | PPT 16:9、小红书、朋友圈等 10+ 种格式（skill 仓库） |
| 🛠️ | [脚本与工具](./src/pptmaster/scripts/README.md) | 所有脚本和命令 |

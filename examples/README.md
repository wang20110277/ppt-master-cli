...
3. SVG files comply with technical specifications (check with `python3 src/pptmaster/scripts/svg_quality_checker.py`)
...
- [Workflow Tutorial](../src/pptmaster/SKILL.md)
- [Chart Templates](../src/pptmaster/templates/charts/)
- [Icon Library](../src/pptmaster/templates/icons/) (640+ icons)
